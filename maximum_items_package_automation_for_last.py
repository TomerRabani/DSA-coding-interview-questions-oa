...
# For all the other groups, the difference between the number of items in adjacent groups must NOT be greater than 1. In other words, for 1 <= i <= n, arr[i] - arr[i - 1] <= 1. To accomplish this, the following operations are available:
...
print(maximum_items_package_automation_for_last([50,1,1,1]))
